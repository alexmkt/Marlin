...
const bool Z_MIN_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop. INVERT THIS FOR Z PROBE
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    #define RIGHT_PROBE_BED_POSITION 134
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -0.61
  

  #define Z_HOMING_HEIGHT 0       // (in mm) Raise Z before homing (G28) for Probe Clearance.
                                        // Be sure you have this distance over your Z_MAX_POS in case

  #define XY_PROBE_SPEED 10000         // X and Y axis travel speed between probes, in mm/min
  ...
  //#define PROBE_SERVO_DEACTIVATION_DELAY 750
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,451}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {15000, 15000, 2.5, 5000}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3500,3500,10,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
//#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 135,30} // X,Y,Z Axis Extend and Retract angles
